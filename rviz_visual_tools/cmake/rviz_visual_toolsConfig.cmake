...
if("FALSE" STREQUAL "TRUE")
  set(rviz_visual_tools_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-rviz-visual-tools-3.6.0)
  set(rviz_visual_tools_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-rviz-visual-tools-3.6.0/obj-x86_64-linux-gnu/devel)
  ...
  set(rviz_visual_tools_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_visual_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
