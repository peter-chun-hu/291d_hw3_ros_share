...
if("FALSE" STREQUAL "TRUE")
  set(aruco_detect_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-aruco-detect-0.8.3)
  set(aruco_detect_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-aruco-detect-0.8.3/obj-x86_64-linux-gnu/devel)
  ...
  set(aruco_detect_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'aruco_detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
