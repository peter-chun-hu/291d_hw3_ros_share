...
if("FALSE" STREQUAL "TRUE")
  set(marker_msgs_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-marker-msgs-0.0.5)
  set(marker_msgs_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-marker-msgs-0.0.5/obj-x86_64-linux-gnu/devel)
  ...
  set(marker_msgs_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'marker_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
